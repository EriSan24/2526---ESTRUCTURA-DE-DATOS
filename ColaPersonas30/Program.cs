...
class Program
{
    ...
    static void Ejercicio2()
    {
        ...
        Console.WriteLine("--- Distribucion de Personas en la Atracción ---");
        colaAtraccion.ReportarCola();

        Console.WriteLine("\n--- Asignando lugares en la Atracción ---");
        colaAtraccion.AsignarAsientos();
    ...
    static void Ejercicio3()
    {
        ...
        Console.WriteLine("\n--- Asignando Asientos de Auditorio ---");
        colaAuditorio.AsignarAsientos();
